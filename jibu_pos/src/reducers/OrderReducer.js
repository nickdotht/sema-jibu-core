...
import { ADD_PRODUCT_TO_ORDER, CLEAR_ORDER, REMOVE_PRODUCT,
	SET_PRODUCT_QUANTITY, SET_ORDER_CHANNEL, SET_ORDER_FLOW } from "../actions/OrderActions";

let initialState = {products:[], channel:{salesChannel:'walkup'}, flow:{page:'products'}};
