...
export const ADD_LOCAL_RECEIPT = 'ADD_LOCAL_RECEIPT';
...
export function addLocalReceipt(receipt) {
    console.log('addLocalReceipt - action');
    return dispatch => { dispatch({ type: ADD_LOCAL_RECEIPT, data: { receipt } }) };
}
